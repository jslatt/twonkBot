  ...
  let floorScanner = setInterval(function () {
    ...
    objectKeysArray.forEach(function (objKey) {
      ...
      const options = {
        ...
        port: null,
        path: "/collections/" + collections[objKey].id + "/stats",
        headers: {
          cookie:
      ...
      const req = http.request(options, function (res) {
        ...
        res.on("end", function () {
          ...
          var objValue = collections[objKey].name + " - " + body.toString();
    ...
    client.channels.cache.get("1067151914535485451").send(payload.toString());
